//渲染模块方式
//bops.renderModule("approvalInfo","/background/approval/approvedInfo.do",{
//	"topicType":$('#topicType').val(),
//	"relateNo":$('#relateNo').val(),
//	"relateType":$('#relateType').val()
//});

//异步数据请求方式
//bops.delayRender(['clientName'],"approvalInfo","/background/approval/approvedInfo.do?topicType="
//		+$('#topicType').val()+"&relateNo="+$('#relateNo').val()+"&relateType="+$('#relateType').val());
var bops = {
	easyui:null,
	basePath : basePath,
