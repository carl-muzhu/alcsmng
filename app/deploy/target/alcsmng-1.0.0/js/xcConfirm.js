...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $txt = $("<p style='height:"+(config.height+34)+"px;'>").html(popHtml);//弹窗文本dom
		...
		var $popBox = $("<div style='height:"+(config.height+140)+"px;width:"+(config.width+400)+"px;'>").addClass("popBox");//弹窗盒子
		var $ttBox = $("<div>").addClass("ttBox");//弹窗顶部区域
		var $txtBox = $("<div style='height:"+config.height+"px;'>").addClass("txtBox");//弹窗内容主体区
